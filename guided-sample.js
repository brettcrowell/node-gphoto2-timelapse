...
var numFrames = ((params.output.minutes * 60) + params.output.seconds) * params.frameRate,
    secondsToLapse = (params.input.days * 24 * 60 * 60) + (params.input.hours * 60 * 60) + (params.minutes * 60) + params.seconds,
    frameInterval = secondsToLapse / numFrames;
